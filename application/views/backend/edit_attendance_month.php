                ...
                <form method="post" action="Upd_Attendance_Month" id="attendanceForm" enctype="multipart/form-data" onsubmit="return validateForm()">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" name="emid" id="emid" required>
                ...
                <form method="post" action="Cpy_Attendance_Month" id="copyForm" enctype="multipart/form-data" onsubmit="return validateForm()">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" name="emid2" id="emid2" required>
                                    <option value="#">Select Here</option>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="submit" id="attendanceCopy" class="btn btn-primary">Submit</button>
                    </div>
                </form>
            </div>
        </div>
